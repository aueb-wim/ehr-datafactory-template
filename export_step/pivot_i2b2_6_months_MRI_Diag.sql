...
DECLARE this_num integer;
DECLARE thisage numeric(18,5);
DECLARE p_num integer;
DECLARE encounternummri integer;
DECLARE gender text;
...
EXECUTE FORMAT('CREATE TABLE temp_table (patient_num integer, mri_date timestamp, encounter_num_mri integer, diag_date timestamp, encounter_num_diag integer, age_diag numeric(18,5), encounter_num_mmse integer, encounter_num_moca integer, CONSTRAINT pkey PRIMARY KEY (patient_num))');
